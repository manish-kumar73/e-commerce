...
const Card = ({ productObj }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden w-full md:w-72 group transform transition-transform duration-300 hover:-translate-y-2">
          ...
          {productInCart ? (
            ...
            <div className="flex w-full space-x-2 ">
              <button
                ...
                className="bg-blue-600 hover:bg-blue-700 text-white cursor-pointer px-2 py-2 text-xs md:text-sm rounded-lg font-bold transition-colors duration-300 w-1/2"
              >
                Add to Cart
              </button>
              <Link
                to={`/product/${productObj.id}`}
                className="bg-blue-600 hover:bg-blue-700 text-white cursor-pointer px-2 py-2  text-xs md:text-sm rounded-lg font-bold transition-colors duration-300 w-1/2 text-center"
              >
                View Details
              </Link>
            </div>
