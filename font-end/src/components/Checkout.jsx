...
import { clearCart } from "../redux/cartSlise.js";
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <button
                ...
                className={`w-full mt-6 py-3 cursor-pointer rounded-lg font-semibold text-lg text-white transition-colors duration-300 ${
